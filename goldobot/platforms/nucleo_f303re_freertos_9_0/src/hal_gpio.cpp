...
const AFDef g_TIM1_alternate_functions[] = {
    0, 0, 8, GPIO_AF6_TIM1, //PA8
...
const AFDef g_TIM2_alternate_functions[] = {
    0, 0, 0, GPIO_AF1_TIM2, //PA0
...
const AFDef g_TIM3_alternate_functions[] = {
    0, 0, 6, GPIO_AF2_TIM3, //PA6
...
const AFDef g_TIM4_alternate_functions[] = {
    0, 0, 11, GPIO_AF10_TIM4, //PA11
...
const AFDef g_TIM6_alternate_functions[] = {
    0xff,0,0,0
};

const AFDef g_TIM7_alternate_functions[] = {
    0xff,0,0,0
};

const AFDef g_TIM8_alternate_functions[] = {
    0, 0, 15, GPIO_AF2_TIM8, //PA15
...
const AFDef g_TIM15_alternate_functions[] = {
    0, 0, 2, GPIO_AF9_TIM15, //PA2
...
const AFDef g_TIM16_alternate_functions[] = {
    0, 0, 6, GPIO_AF1_TIM16, //PA6
...
const AFDef g_TIM17_alternate_functions[] = {
    0, 0, 7, GPIO_AF1_TIM17, //PA7
...
const AFDef g_TIM20_alternate_functions[] = {
    0xff,0,0,0
};

const AFDef g_CAN_alternate_functions[] = {
    0, 0, 11, GPIO_AF9_CAN, //PA11
...
const AFDef g_I2C1_alternate_functions[] = {
    0, 0, 15, GPIO_AF4_I2C1, //PA15
...
const AFDef g_I2C2_alternate_functions[] = {
    0, 0, 9, GPIO_AF4_I2C2, //PA9
...
const AFDef g_I2C3_alternate_functions[] = {
    0, 0, 8, GPIO_AF3_I2C3, //PA8
    1, 1, 5, GPIO_AF8_I2C3, //PB5
    1, 2, 9, GPIO_AF3_I2C3, //PC9
    0xff,0,0,0
};

const AFDef g_SPI1_alternate_functions[] = {
    2, 0, 6, GPIO_AF5_SPI1, //PA6
...
const AFDef g_SPI2_alternate_functions[] = {
    2, 0, 10, GPIO_AF5_SPI2, //PA10
...
const AFDef g_SPI3_alternate_functions[] = {
    2, 1, 4, GPIO_AF6_SPI3, //PB4
...
const AFDef g_USART1_alternate_functions[] = {
    0, 0, 10, GPIO_AF7_USART1, //PA10
...
const AFDef g_USART2_alternate_functions[] = {
    0, 0, 3, GPIO_AF7_USART2, //PA3
...
const AFDef g_USART3_alternate_functions[] = {
    0, 1, 8, GPIO_AF7_USART3, //PB8
...
const AFDef g_UART4_alternate_functions[] = {
    0, 2, 11, GPIO_AF5_UART4, //PC11
    1, 2, 10, GPIO_AF5_UART4, //PC10
    0xff,0,0,0
};

const AFDef g_UART5_alternate_functions[] = {
    0, 3, 2, GPIO_AF5_UART5, //PD2
    1, 2, 12, GPIO_AF5_UART5, //PC12
    0xff,0,0,0
};

const AFDef* g_periph_alternate_functions_ptrs[] = {
    g_TIM1_alternate_functions,
    g_TIM2_alternate_functions,
    g_TIM3_alternate_functions,
    g_TIM4_alternate_functions,
    g_TIM6_alternate_functions,
    g_TIM7_alternate_functions,
    g_TIM8_alternate_functions,
    g_TIM15_alternate_functions,
    g_TIM16_alternate_functions,
    g_TIM17_alternate_functions,
	g_TIM20_alternate_functions,
    g_CAN_alternate_functions,
    g_I2C1_alternate_functions,
    g_I2C2_alternate_functions,
    g_I2C3_alternate_functions,
    g_SPI1_alternate_functions,
    g_SPI2_alternate_functions,
    g_SPI3_alternate_functions,
    g_USART1_alternate_functions,
    g_USART2_alternate_functions,
    g_USART3_alternate_functions,
    g_UART4_alternate_functions,
    g_UART5_alternate_functions
};

GPIO_TypeDef* g_gpio_ports[] = {
		GPIOA,
		GPIOB,
		GPIOC,
		GPIOD,
