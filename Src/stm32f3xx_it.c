...
{
	goldobot_hal_i2c_ev_irq_handler(0);
}

void I2C1_ER_IRQHandler(void)
{
	goldobot_hal_i2c_er_irq_handler(0);
}

void I2C2_EV_IRQHandler(void)
{
	goldobot_hal_i2c_ev_irq_handler(1);
}

void I2C2_ER_IRQHandler(void)
{
	goldobot_hal_i2c_er_irq_handler(1);
}

void I2C3_EV_IRQHandler(void)
{
	goldobot_hal_i2c_ev_irq_handler(2);
}

void I2C3_ER_IRQHandler(void)
{
	goldobot_hal_i2c_er_irq_handler(2);
}

void SPI1_IRQHandler(void)
{
	goldobot_hal_spi_irq_handler(0);
}

void SPI2_IRQHandler(void)
{
	goldobot_hal_spi_irq_handler(1);
}

void SPI3_IRQHandler(void)
{
	goldobot_hal_spi_irq_handler(2);
}

void SPI4_IRQHandler(void)
{
	goldobot_hal_spi_irq_handler(3);
}
